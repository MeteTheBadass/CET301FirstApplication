  ...
  Widget build(BuildContext context){
    return Column(
      children: [
        ...
        Expanded(child: Container(alignment: Alignment.topLeft,padding: new EdgeInsets.only(left: 15,top: 5),child: Text('Metehan Karaşahinoğlu', style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,fontFamily: 'BS',color: Color(0xFF1E8449)),),), flex: 10,),
